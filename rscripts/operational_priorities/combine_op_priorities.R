...
folder_name <- 'actuals_from_warehouse\\OP_priority_actuals'
...
write_csv(current_actuals,paste0('actuals_from_warehouse\\staging\\operational_priority_staging.csv'))
